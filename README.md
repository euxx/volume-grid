...
1. Launch the app; it will continue to run in the background.
2. A volume icon appears in the menu bar.
3. Adjusting the system volume shows the classic HUD overlay.
4. Click the menu bar icon to view the current volume and output device.
5. Enable launch at login from the menu if desired.
